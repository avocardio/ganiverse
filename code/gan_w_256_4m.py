...
SAVED_MODEL_PATH = 'data/saved_model/256_4m/'
SAVED_MODEL_PATH_50 = 'data/saved_model/256_4m/50/'
...
class Generator(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # Input random noise
        self.g.add(tf.keras.layers.Dense(16*16*128, use_bias=False, input_shape=(100,)))
